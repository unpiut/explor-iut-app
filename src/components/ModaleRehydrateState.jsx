    ...
    <div className="absolute lg:left-1/2 top-1/3 z-50 ">
      <div className="relative lg:left-[-50%] bg-slate-50 border-2 border-blue-900 text-center justify-center grid">
        <div className="flex gap-2 justify-between p-2">
          ...
          <button className="cursor-pointer text-xl font-bold" type="button" onClick={onCancel}>X</button>
        </div>
        <div className="border-t-2 p-2 mt-1 border-blue-800">
          ...
          <p>
            <button
              onClick={onCancel}
              type="button"
              className="cursor-pointer max-w-full wrap-break-word text-xs p-1 m-2 md:text-base align-middle text-center border-2 border-black` bg-contain font-bold"
            >
            ...
            <button
              onClick={onConfirm}
              type="button"
              className="cursor-pointer max-w-full wrap-break-word text-xs p-1 m-2 md:text-base align-middle text-center border-2 border-blue-900 bg-contain font-bold"
            >
