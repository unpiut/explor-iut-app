      ...
      <form method="GET">
        ...
        <div className="m-2">
          <label htmlFor="alternance" className="block text-sm font-medium leading-6">
            Offres d&apos;alternance, 3 maximum (Non obligatoire)
            <input type="file" accept=".pdf" onChange={trySubmitFile} multiple name="alternance" id="alternance" className="p-1 block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </label>
        </div>
      </form>
