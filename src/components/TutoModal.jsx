...
import videoTuto from '../assets/tuto.mp4';

function TutoModal({ isOpen, onClose }) {
      ...
      <div className="relative w-full max-w-3xl mx-4 bg-white rounded-sm shadow-2xl border-2 border-blue-900 overflow-hidden">
        <div className="flex items-center justify-between px-5 py-3 bg-blue-900">
          ...
          <button
            ...
            aria-label="Fermer"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 stroke-white hover:stroke-3" fill="none" viewBox="0 0 24 24" strokeWidth={2}>
        ...
        <div className="relative w-full bg-black" style={{ paddingBottom: '56.25%' }}>
          <video
            ...
            src={videoTuto}
          >
            {/* Fallback pour les sous-titres */}
            <track kind="captions" srcLang="fr" label="Français" />
            {t('tutoVideoNonSupporte', 'Votre navigateur ne supporte pas la lecture vidéo.')}
          </video>
        </div>
