    ...
    <>
      ...
      <div className="grid justify-items-center gap-10">
        ...
        <div className="grid gap-5 xl:grid-cols-3 text-center justify-center">
          <div className="relative pb-4 m-auto h-full w-2/3 border-2 border-blue-900 transform transition duration-300 hover:scale-105">
          ...
          <div className="hover:scale-200 relative pb-4 m-auto h-full w-2/3 border-2 border-blue-900">
            <div>
